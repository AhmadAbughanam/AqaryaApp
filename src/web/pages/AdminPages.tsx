...
export function AdminDashboardPage() {
  ...
  return (
    <>
      <PageHeader eyebrow="Government operations" title="Command center" description="A live overview of verification, moderation, and citizen service queues." />
