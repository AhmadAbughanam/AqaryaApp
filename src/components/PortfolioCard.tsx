...
import {formatCurrencyNoFraction, formatNumber, formatDateTime} from '../utils/formatters';
      ...
      <View style={styles.valueBanner}>
        <View style={styles.valueBannerItem}>
          ...
          <Text style={styles.valueBannerAmount}>
            {formatCurrencyNoFraction(item.simulatedValue)}
          </Text>
        </View>
        ...
        <View style={styles.valueBannerItem}>
          ...
          <Text style={styles.valueBannerAmount}>
            {formatCurrencyNoFraction(item.pricePerShare)}
          </Text>
        </View>
      </View>
