          ...
          <View>
            ...
            <View style={st.balCard}>
              ...
              <Text style={st.balAmount}>
                ...
                {formatTwoDecimalsExact(balance?.ejodBalance ?? 0)}
              </Text>
              ...
              <View style={st.balTilesRow}>
                <BalanceTile
                  label={w.available}
                  value={`JOD ${formatTwoDecimalsExact(balance?.availableBalance ?? 0)}`}
                  accent
                />
                <View style={st.balTileSep} />
                <BalanceTile
                  label={w.locked}
                  value={`JOD ${formatTwoDecimalsExact(balance?.lockedAmount ?? 0)}`}
                />
                <View style={st.balTileSep} />
                <BalanceTile
                  label={w.pending}
                  value={`JOD ${formatTwoDecimalsExact(balance?.pendingDeposits ?? 0)}`}
                />
              </View>
          ...
          <View style={st.txRow}>
            ...
            <View style={st.txRight}>
              <Text style={[st.txAmount, {color: TX_COLOR[item.type]}]}>
                {TX_SIGN[item.type]}JOD {formatTwoDecimalsExact(item.amount)}
              </Text>
              <View style={[
                st.txStatusBadge,
