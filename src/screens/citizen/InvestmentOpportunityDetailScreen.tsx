...
import {formatCurrency, formatDecimals2} from '../../utils/formatters';
...
const InvestmentOpportunityDetailScreen = () => {
  ...
  const onInvest = () => {
    ...
    if (!walletBalance || walletBalance.availableBalance < estimatedTotal) {
      const needed = formatDecimals2(estimatedTotal);
      const have   = walletBalance
        ? formatDecimals2(walletBalance.availableBalance)
        : '0.00';
      Alert.alert(
    ...
    const totalFmt = formatDecimals2(estimatedTotal);
    Alert.alert(
          ...
          right={
            <View style={s.headerBalance}>
              ...
              <Text style={s.headerBalanceText}>
                {walletBalance != null
                  ? `JOD ${formatDecimals2(walletBalance.availableBalance)}`
                  : '—'}
              </Text>
            </View>
          }
