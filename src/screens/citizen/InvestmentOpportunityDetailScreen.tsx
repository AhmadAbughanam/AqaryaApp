...
import {formatCurrency, formatMin2Fraction} from '../../utils/formatters';
...
const InvestmentOpportunityDetailScreen = () => {
  ...
  const onInvest = () => {
    ...
    if (!walletBalance || walletBalance.availableBalance < estimatedTotal) {
      const needed = formatMin2Fraction(estimatedTotal);
      const have   = walletBalance
        ? formatMin2Fraction(walletBalance.availableBalance)
        : '0.00';
      Alert.alert(
    ...
    const totalFmt = formatMin2Fraction(estimatedTotal);
    Alert.alert(
          ...
          right={
            <View style={s.headerBalance}>
              ...
              <Text style={s.headerBalanceText}>
                {walletBalance != null
                  ? `JOD ${formatMin2Fraction(walletBalance.availableBalance)}`
                  : '—'}
              </Text>
            </View>
          }
