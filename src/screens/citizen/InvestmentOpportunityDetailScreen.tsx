...
import {formatCurrency, formatDecimal2Min} from '../../utils/formatters';
...
const InvestmentOpportunityDetailScreen = () => {
  ...
  const onInvest = () => {
    ...
    if (!walletBalance || walletBalance.availableBalance < estimatedTotal) {
      const needed = formatDecimal2Min(estimatedTotal);
      const have   = walletBalance
        ? formatDecimal2Min(walletBalance.availableBalance)
        : '0.00';
      Alert.alert(
    ...
    const totalFmt = formatDecimal2Min(estimatedTotal);
    Alert.alert(
