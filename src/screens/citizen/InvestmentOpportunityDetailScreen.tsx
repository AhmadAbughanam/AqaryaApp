...
import { formatCurrency, formatFraction } from '../../utils/formatters';
...
const InvestmentOpportunityDetailScreen = () => {
  ...
  const onInvest = () => {
    ...
    if (!walletBalance || walletBalance.availableBalance < estimatedTotal) {
      const needed = formatFraction(estimatedTotal);
      const have   = walletBalance
        ? formatFraction(walletBalance.availableBalance)
        : '0.00';
      Alert.alert(
    ...
    const totalFmt = formatFraction(estimatedTotal);
    Alert.alert(
