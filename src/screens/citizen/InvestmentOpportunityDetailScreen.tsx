...
import { formatCurrencyNoFraction as fmt$, formatMin2 } from '../../utils/formatters';
...
const InvestmentOpportunityDetailScreen = () => {
  ...
  const onInvest = () => {
    ...
    if (!walletBalance || walletBalance.availableBalance < estimatedTotal) {
      const needed = formatMin2(estimatedTotal);
      const have   = walletBalance
        ? formatMin2(walletBalance.availableBalance)
        : '0.00';
      Alert.alert(
    ...
    const totalFmt = formatMin2(estimatedTotal);
    Alert.alert(
          ...
          right={
            <View style={s.headerBalance}>
              ...
              <Text style={s.headerBalanceText}>
                {walletBalance != null
                  ? `JOD ${formatMin2(walletBalance.availableBalance)}`
                  : '—'}
              </Text>
            </View>
          }
